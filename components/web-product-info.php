<div class="comp web-product-info_comp">
    <div class="web-product-info_cr">
        
        <p class="web-designer_info">
            <?php $url = 'http://designdrive.co/hopscotch/'; echo sprintf( __( '<a class="web-designer-name_axn" href="%s">HopScotch</a>', 'hopscotch'), esc_url( $url ) ); ?>
            <span class="label">
