...
if ( ! function_exists( 'hopscotch_article_entry_tags' ) ) :
    function hopscotch_article_entry_tags() {
        ...
        if ( $tags_list ) {
            ...
            printf( '<div class="comp tag_comp tag-tag_comp article-entry-tag_comp"><div class="cr tag_cr tag-tag_cr article-entry-tag_cr"><span class="accessible-name tag_accessible-name tag-tag_accessible-name">%1$s</span> %2$s</div></div><!-- article-entry-tag_comp -->',
