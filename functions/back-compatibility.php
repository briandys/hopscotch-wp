 ...
 * @since Twenty Fifteen 1.0
 */
function hopscotch_switch_theme() {
	switch_theme( WP_DEFAULT_THEME, WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'hopscotch_upgrade_notice' );
}
add_action( 'after_switch_theme', 'hopscotch_switch_theme' );
 ...
 * @since Twenty Fifteen 1.0
 */
function hopscotch_upgrade_notice() {
...
add_action( 'load-customize.php', 'hopscotch_customize' );
...
add_action( 'template_redirect', 'hopscotch_preview' );
