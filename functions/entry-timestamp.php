...
if ( ! function_exists( 'hopscotch_entry_published_timestamp' ) ) :
	function hopscotch_entry_published_timestamp() {
		...
		if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
            ...
            printf( '<div class="comp timestamp_comp entry-published-timestamp_comp"><div class="entry-published-timestamp_cr"><span class="label">%1$s</span> <a class="entry-published-timestamp_axn" href="%2$s" title="Permalink to %4$s" rel="bookmark">%3$s</a></div></div><!-- entry-published-timestamp_comp -->',
...
if ( ! function_exists( 'hopscotch_entry_modified_timestamp' ) ) :
	function hopscotch_entry_modified_timestamp() {
		...
		if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
            ...
            printf( '<div class="comp timestamp_comp entry-modified-timestamp_comp"><div class="entry-modified-timestamp_cr"><span class="label">%1$s</span> <a class="entry-modified-timestamp_axn" href="%2$s" title="Permalink to %4$s" rel="bookmark">%3$s</a></div></div><!-- entry-modified-timestamp_comp -->',
