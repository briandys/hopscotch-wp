            ...
            <div class="cr article-entry-comments-actions_cr">
                ...
                <ul class="grp article-entry-comments-actions_grp">
                    ...
                    <?php comments_popup_link(
                        // Zero comment
                        __( '<li class="item article-entry-comments-actions_item zero"><span class="label pred_label">Write</span> ' .
                            '<span class="label subj_label">Comment</span>', 'hopscotch' ),

                        // Single comment
                        __( '<li class="item article-entry-comments-actions_item single"><span class="label pred_label">' .
                        ...
                        // Multiple comments
                        __( '<li class="item article-entry-comments-actions_item multi"><span class="label pred_label">' .
                            '<span class="label verb_label">Show</span> ' .
